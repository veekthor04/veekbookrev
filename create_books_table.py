...
def main():
     users_table= db.execute("CREATE TABLE Books (id SERIAL NOT	NULL,isbn VARCHAR PRIMARY KEY NOT NULL,title VARCHAR NOT NULL,author VARCHAR NOT NULL,year INTEGER NOT NULL)")
     db.commit()
